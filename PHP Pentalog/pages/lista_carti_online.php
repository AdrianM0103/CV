...
if(isset($_SESSION["username"])){
    ...
    if($_SESSION["expire"]<$now){
        ...
        header('location: lista_carti_offline.php');
    }
}
else
    header('location:lista_carti_offline.php');
        ...
        <div class="container cont1">
            <div class="row filtre">
                <div class="col col-xl col-md col-xs filtre">
                    <form method="POST" action="functions/filter-genuri-online.php">
                    <p>Genuri</p>
                    <?php
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        <div class="container cont2">
            ...
            <div class="col sortare">
                <form method="POST" action="functions/sortare-online.php">
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////                        
            ...
            <div class="col">
                    <form name="search" action="functions/select_online.php" method="GET">
                ...
                <div class="col">
                    <form action="functions/search_online.php" method="GET">
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
             ...
             if(!isset($_GET["carti"])){
                ...
                while($carte = mysqli_fetch_assoc($lista))
                {
                    $ok=true;
                    $nr_carti++;
                    echo '<a href="carte_online.php?carte='.$carte["id_carte"].'" class= "btn col col-md carte"><img src='.$carte["poza"].$carte["poza_suf"].' class="img_carte"><p>'.$carte["titlu"].'</p></a>';
                    if($nr_carti==3){
